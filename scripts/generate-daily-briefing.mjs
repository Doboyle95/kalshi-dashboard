...
const ESCALATION = " Be concrete this time. Pick one table from the rotation -- taker_pnl_daily, parlay_top_games_by_volume, extreme_trades_daily, daily_sports_vs_nonsports, taker_notional_daily or parlay_lottery_daily -- query it for Kalshi's own latest complete date, compare that figure against its average over the prior thirty reported days, and put the result in the Kalshi bullet after the headline volume. Do not reuse an August-to-date parlay share. If parlay_lottery_daily is strongest, call the subset parlays with at least eight legs trading below 2 cents or extremely long-odds parlays; never expose the internal table label.";
