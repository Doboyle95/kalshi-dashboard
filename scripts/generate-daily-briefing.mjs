...
const editorialQuestion = [
  ...
  "Use the supplied venue-volume table as the anchor, then run only the supporting context queries needed to find genuinely interesting changes in product mix, sports versus non-sports, fee revenue, taker-side volume or P&L, parlay activity, and unusually large individual trades.",
  ...
  "Return three to five concise bullets, no more than 160 words total. Lead each bullet with a bold factual phrase, quantify changes against a sensible recent baseline, and do not force a topic when nothing notable happened.",
