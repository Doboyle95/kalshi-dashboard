---
title: Polymarket US · Economics
---

<div class="page-hero" data-accent="polymarket">
  <div class="page-eyebrow">Polymarket US</div>
  <h1>What it charges</h1>
  <p class="page-lead">Fees Polymarket US has collected, and what that works out to per dollar of contract.</p>
</div>
...
const rows = feeRows(competitorDaily.filter(d => d.platform === "Polymarket_US"), VENUE);
...
<div class="instruction-line" style="border-left-color:var(--theme-foreground-muted)">See also: <a href="./polymarket">Polymarket US &middot; Activity</a>, and <a href="./compare-fees">Fees across venues</a> for the comparison.</div>
