...
<details class="surface-card compact-details">
  ...
  <p>The reports do not publish fees, so every fee is modeled from public schedules at execution grain. From DraftKings' June 26 retail launch, customer cost is its introducing-broker transaction fee plus DKeX's separate exchange fee; DKeX exchange revenue remains the filed taker charge plus the $0.0025 maker charge and excludes the broker commission. The current broker ladder was first observed September 2, 2026, so earlier history is not silently rewritten with a schedule that publishes no effective date.</p>
</details>
