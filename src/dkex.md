...
<details class="surface-card compact-details">
  ...
  <p><strong>Weighting.</strong> Contract-weighted, matching the Kalshi series on <a href="./compare-accuracy">Accuracy &amp; Outcomes</a> (<code>yes_contracts / n_contracts</code>): of every contract bought near 25&cent;, what share paid out. The trade-weighted rate ships in the same file.</p>
