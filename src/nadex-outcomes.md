...
<details class="surface-card compact-details">
  ...
  <p><strong>The x-axis is already the price paid.</strong> OG/Crypto.com publishes a contract-weighted mean price off its own tape, so unlike the other venue files nothing has to be reconstructed from a band midpoint here.</p>
