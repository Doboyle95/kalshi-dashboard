...
<details class="surface-card compact-details">
  ...
  <p><strong>This is the whole contract suite, not just parlays.</strong> Calibration asks whether a contract trading at a price resolves that way that often, which needs no aggressor flag &mdash; so crypto strikes, event contracts and combos all qualify. OG/Crypto.com parlay P&amp;L, on its own <a href="./nadex-parlay-outcomes">Parlay outcomes</a> tab, is parlays-only, because buyer-equals-taker holds only for a house-quoted combo. The two are different populations and should not be read as one.</p>
  <p><strong>The x-axis is already the price paid.</strong> OG/Crypto.com publishes a contract-weighted mean price from its own trade records, so unlike the other venue files nothing has to be reconstructed from a band midpoint here.</p>
  ...
  <p><strong>A contract count is a dollar count here.</strong> OG/Crypto.com binaries settle at $1, the one venue on this site where the two are the same number.</p>
</details>

<div class="instruction-line" style="border-left-color:var(--theme-foreground-muted)">See also: OG/Crypto.com volume and contract mix on <a href="./nadex">OG/Crypto.com · Activity</a>; parlay P&amp;L on <a href="./nadex-parlay-outcomes">Parlay outcomes</a>; the same series against every other venue on <a href="./compare-accuracy">Accuracy &amp; Outcomes</a>.</div>
