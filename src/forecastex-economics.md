---
title: ForecastEx · Economics
---

<div class="page-hero" data-accent="forecastex">
  <div class="page-eyebrow">ForecastEx</div>
  <h1>What it charges</h1>
  <p class="page-lead">Fees ForecastEx has collected, and what that works out to per dollar of contract.</p>
</div>
...
const rows = feeRows(competitorDaily.filter(d => d.platform === "ForecastEx"), VENUE);
...
<div class="instruction-line" style="border-left-color:var(--theme-foreground-muted)">See also: <a href="./forecastex">ForecastEx &middot; Activity</a>, and <a href="./compare-fees">Fees across venues</a> for the comparison.</div>
