...
<details class="surface-card compact-details">
  ...
  <p><strong>Voids are excluded, and that exclusion is load-bearing.</strong> A refunded event has no outcome: both legs of a voided or postponed event settle at $0.50. Void prints, pro-rated partials and not-yet-settled markets are removed before binning &mdash; about 0.43% of the recorded trades. Before the 2026-08-06 settlement fix, voids were scored as <em>wins</em>, which alone moved the 10&ndash;20&cent; band from &minus;0.18&cent; to +4.01&cent;.</p>
