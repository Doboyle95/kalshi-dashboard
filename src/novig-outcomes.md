...
<div class="instruction-line" style="border-left-color:var(--theme-foreground-muted)">See also: this series in <a href="./compare-accuracy">Accuracy &amp; Outcomes</a>; Novig's volume, fees and parlay length on <a href="./novig">Novig · Activity</a>.</div>
