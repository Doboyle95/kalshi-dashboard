...
const daily = await DataAttachment("data/taker_pnl_daily.csv").csv({typed: true});
const makerDaily = await DataAttachment("data/maker_pnl_daily.csv").csv({typed: true});
const takerVolumeDaily = await DataAttachment("data/taker_notional_daily.csv").csv({typed: true});
const pnlByTicker = await DataAttachment("data/taker_pnl_by_ticker_daily.csv").csv({typed: true});
