...
<details class="surface-card compact-details">
  ...
  traded</em> &mdash; which side was the aggressor. Only Kalshi publishes that flag per trade,
  and parlays are the one exception, because they are priced by request-for-quote: the customer
  lifts a quote the venue makes, so the taker is the buyer by construction.
  ...
  <p><strong>Why the venues with big parlay books are still not here.</strong> Underdog, Novig,
  Crypto.com/Nadex and ProphetX all run substantial parlay volume, and request-for-quote pricing
  would settle who paid. What none of them publishes is <em>what happened</em>. Underdog and
  Novig give a closing price and a status that only ever reads &ldquo;Finalized&rdquo; &mdash;
  across 4,972 Underdog tickers not one ends at a settled 0 or 1, and of 282 two-sided game-win
  ...
  per-contract settlement. The missing half is outcomes, not prices.</p>
