...
<div class="page-hero" data-accent="rothera">
  ...
  <p class="page-lead">The mix of contract categories Rothera lists, day by day.</p>
</div>
...
<div class="instruction-line" style="border-left-color:var(--theme-foreground-muted)">See also: <a href="./rothera">Rothera &middot; Activity</a> for volume and top markets, and <a href="./categories-venues">Products across venues</a> for the comparison.</div>
