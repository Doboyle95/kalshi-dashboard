---
title: Underdog Exchange · Economics
---

<div class="page-hero" data-accent="underdog">
  <div class="page-eyebrow">Underdog Exchange</div>
  <h1>What it charges</h1>
  <p class="page-lead">Fees Underdog Exchange has collected, and what that works out to per dollar of contract.</p>
</div>
...
const rows = feeRows(competitorDaily.filter(d => d.platform === "Underdog Exchange"), VENUE);
...
<div class="instruction-line" style="border-left-color:var(--theme-foreground-muted)">See also: <a href="./underdog">Underdog Exchange &middot; Activity</a>, and <a href="./compare-fees">Fees across venues</a> for the comparison.</div>
